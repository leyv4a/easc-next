    ...
    return (
        <section className={"items-center justify-center  md:h-[80vh] flex flex-col gap-3 "}>
            <article className={"flex flex-col justify-center w-full "}>
                <h1 className={"text-8xl md:text-9xl xl:text-[14.6rem] text-center font-karla font-bold tracking-widest leading-none  bg-gradient-to-r from-white from-30% via-[#f3922b] text-transparent bg-clip-text to-white bg-300% animate-gradient"}>MAR
                    Y VIDA</h1>
...
const FeaturesButton: React.FC<FeaturesButtonProps> = ({icon, label}) => (
    <a
        href={""}
        className={`mb-2 border border-[#E97451]/30 hover:border-[#E97451]/80 transition duration-300 shadow-md hover:shadow-lg flex flex-col justify-center items-center bg-[#2a4d69]/80 hover:bg-[#2a4d69] text-white text-xl font-karla font-semibold p-4 w-40 h-40`}
    >
        {icon}
        {label}
    </a>
