      ...
      <>
          <main className="relative max-w-full min-h-screen overflow-x-hidden">
              ...
              <div className="relative z-10 lg:w-[80vw] container mx-auto mt-40 lg:mt-12">
                  <Navbar/>
                  <Hero/>
             {/*     CONTENEDOR DE SLIDER PUBLICITARIO*/}
              </div>
          </main>
          <ConoceSanCarlos/>
          <Seccion2/>
...
function Footer(){
    return (
        <>
            <footer className={"relative bottom-0 left-0 w-full h-[80vh] min-h-[80vh]"}>
                    {/* Fondo de color */}
                    <div
                        ...
                        <div className="flex flex-col lg:flex-row gap-6 text-[#2b5c78] w-full h-full mt-10">
                            ...
                            <div className="lg:w-1/2 flex justify-start gap-5 mt-5">
                               <FooterItems title={"Recursos"} items={["Seguridad", "Numeros de telefono", "Buses"]}/>
                                ...
                                <FooterItems title={"Otros"} items={["Mapa", "Publicidad", "Política de privacidad", "Terminos y condiciones"]}/>
                            </div>
                            <div className="lg:w-1/2 flex justify-start flex-col gap-5 items-center">
                                ...
                                <div className="space-y-4 w-full max-w-md mx-auto">
                                    ...
                                    <button className={"bg-[#e97451] hover:bg-[#e97451]/90 w-1/2 mt-2 p-2 text-white rounded-md"}>
                                        Enviar
                                    </button>
                                </div>
                            </div>
